...
gulp.task("build-css", () => {
    return gulp.src("./src/assets/bootstrap/*.css")
                .pipe(gulp.dest(dist))
                .pipe(browsersync.stream());
});
...
gulp.task("watch", () => {
    ...
    gulp.watch("./src/assets/bootstrap/*.css", gulp.parallel("build-css"));
    gulp.watch("./src/assets/img/**/*.*", gulp.parallel("imagemin"));
    gulp.watch("./src/assets/icons/**/*.*", gulp.parallel("iconsmin"));
});

gulp.task("build", gulp.parallel("copy-html", "build-js", "build-sass", "build-css"));
...
gulp.task("prod", () => {
    gulp.src("./src/assets/sass/style.scss")
        ...
        .pipe(cleanCSS())
        .pipe(gulp.dest(dist));
    gulp.src("./src/assets/bootstrap/*.css")
        .pipe(cleanCSS())
        .pipe(gulp.dest(dist));
